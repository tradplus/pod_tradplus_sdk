//
//  MMRExpandModalViewController.h
//  MsSDK
//
...
#import "MSClosableView.h"
#import "MSForceableOrientationProtocol.h"
@protocol MMRExpandModalViewControllerDelegate;

/**
 * `MMRExpandModalViewController` is specifically for presenting expanded MMRAID ads. Its orientation can be
 * forced via the orientationMask property.
 */
@interface MMRExpandModalViewController : UIViewController <MSClosableViewDelegate, MSForceableOrientationProtocol>

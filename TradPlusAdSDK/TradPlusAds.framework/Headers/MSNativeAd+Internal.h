...
@interface MSNativeAd (Internal)

@property (nonatomic, readonly) NSDate *creationDate;
@property (nonatomic) MSNativeView *associatedView;
@property (nonatomic, readwrite, strong) id<MSNativeAdRenderer> renderer;
@property (nonatomic, readonly) NSMutableSet *clickTrackerURLs;
@property (nonatomic, readonly) NSMutableSet *impressionTrackerURLs;
@property (nonatomic, readonly, strong) id<MSNativeAdAdapter> adAdapter;

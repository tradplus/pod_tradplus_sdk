 ...
 * mediation settings by calling `[-instanceMediationSettingsForClass:]([MSRewardedVideoCustomEventDelegate -instanceMediationSettingsForClass:])`
 ...
 */
@protocol MSMediationSettingsProtocol <NSObject>

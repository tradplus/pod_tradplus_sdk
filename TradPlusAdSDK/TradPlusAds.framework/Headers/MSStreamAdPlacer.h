...
@protocol MSStreamAdPlacerDelegate;
@protocol MSNativeAdRendering;
...
@interface MSStreamAdPlacer : NSObject
...
@property (nonatomic, weak) id<MSStreamAdPlacerDelegate> delegate;
@property (nonatomic, readonly, copy) MSAdPositioning *adPositioning;
 ...
 *
 */
+ (instancetype)placerWithViewController:(UIViewController *)controller adPositioning:(MSAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
@protocol MSStreamAdPlacerDelegate <NSObject>

@optional
- (void)adPlacer:(MSStreamAdPlacer *)adPlacer didLoadAdAtIndexPath:(NSIndexPath *)indexPath;
- (void)adPlacer:(MSStreamAdPlacer *)adPlacer didRemoveAdsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)nativeAdWillPresentModalForStreamAdPlacer:(MSStreamAdPlacer *)adPlacer;
 ...
 */
- (void)nativeAdDidDismissModalForStreamAdPlacer:(MSStreamAdPlacer *)adPlacer;
 ...
 */
- (void)nativeAdWillLeaveApplicationFromStreamAdPlacer:(MSStreamAdPlacer *)adPlacer;

//
//  MSStaticNativeAdImpressionTimer.h
//  MsSDK
//
...
@protocol MSStaticNativeAdImpressionTimerDelegate;

@interface MSStaticNativeAdImpressionTimer : NSObject

@property (nonatomic, weak) id<MSStaticNativeAdImpressionTimerDelegate> delegate;
...
@protocol MSStaticNativeAdImpressionTimerDelegate <NSObject>

...
@protocol MSTableViewAdPlacerDelegate;
...
@interface MSTableViewAdPlacer : NSObject

@property (nonatomic, weak) id<MSTableViewAdPlacerDelegate> delegate;
 ...
 *
 * @return An `MSTableViewAdPlacer` object.
 */
 ...
 * @return An `MSTableViewAdPlacer` object.
 */
+ (instancetype)placerWithTableView:(UITableView *)tableView viewController:(UIViewController *)controller adPositioning:(MSAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
@interface UITableView (MSTableViewAdPlacer)

- (void)mp_setAdPlacer:(MSTableViewAdPlacer *)placer;
 ...
 */
- (MSTableViewAdPlacer *)mp_adPlacer;
...
@protocol MSTableViewAdPlacerDelegate <NSObject>
 ...
 */
-(void)nativeAdWillPresentModalForTableViewAdPlacer:(MSTableViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdDidDismissModalForTableViewAdPlacer:(MSTableViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdWillLeaveApplicationFromTableViewAdPlacer:(MSTableViewAdPlacer *)placer;

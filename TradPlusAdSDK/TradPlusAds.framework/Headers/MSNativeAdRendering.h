...
@class MSNativeAdRenderingImageLoader;

/**
 * The MSNativeAdRendering protocol provides methods for displaying ad content in
 * custom view classes.
 *
...
@protocol MSNativeAdRendering <NSObject>
 ...
 */
- (void)layoutCustomAssetsWithProperties:(NSDictionary *)customProperties imageLoader:(MSNativeAdRenderingImageLoader *)imageLoader;

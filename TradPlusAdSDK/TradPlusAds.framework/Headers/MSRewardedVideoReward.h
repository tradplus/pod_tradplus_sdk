 ...
 */
extern NSString *const gMPRewardedVideoRewardCurrencyTypeUnspecified;

/**
 * A constant that indicates that no currency amount was specified with the reward.
 */
extern NSInteger const gMPRewardedVideoRewardCurrencyAmountUnspecified;


/**
 * `MSRewardedVideoReward` contains all the information needed to reward the user for watching
 * a rewarded video ad. The class provides a currency amount and currency type.
 */

@interface MSRewardedVideoReward : NSObject

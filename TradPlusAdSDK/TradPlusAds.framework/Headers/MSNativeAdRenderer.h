 ...
 */
@protocol MSNativeAdRenderer <NSObject>

@required

/**
 * You must construct and return an MSNativeAdRendererConfiguration object specific for your renderer. You must
 ...
 */
- (instancetype)initWithRendererSettings:(id<MSNativeAdRendererSettings>)rendererSettings;
 ...
 */
- (UIView *)retrieveViewWithAdapter:(id<MSNativeAdAdapter>)adapter error:(NSError **)error;
...
/**
 * The MsSDK will notify your renderer when your native ad's view has moved in
...
/**
 *
 * The MsSDK will call this method when the user has tapped the ad and will

...
@protocol MSCollectionViewAdPlacerDelegate;
...
@interface MSCollectionViewAdPlacer : NSObject

@property (nonatomic, weak) id<MSCollectionViewAdPlacerDelegate> delegate;
 ...
 * `MSServerAdPositioning` object as the `positioning` parameter.
 *
 ...
 *
 * @return An `MSCollectionViewAdPlacer` object.
 */
 ...
 * this as well.
 *
 * Alternatively, if you wish to hard-code your positions, you may pass an `MSClientAdPositioning`
 * object instead.
 *
 * @param collectionView The collection view in which to insert ads.
 * @param controller The view controller which should be used to present modal content.
 ...
 * @return An `MSCollectionViewAdPlacer` object.
 */
+ (instancetype)placerWithCollectionView:(UICollectionView *)collectionView viewController:(UIViewController *)controller adPositioning:(MSAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
@interface UICollectionView (MSCollectionViewAdPlacer)

- (void)mp_setAdPlacer:(MSCollectionViewAdPlacer *)placer;
 ...
 */
- (MSCollectionViewAdPlacer *)mp_adPlacer;
...
@protocol MSCollectionViewAdPlacerDelegate <NSObject>
 ...
 */
-(void)nativeAdWillPresentModalForCollectionViewAdPlacer:(MSCollectionViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdDidDismissModalForCollectionViewAdPlacer:(MSCollectionViewAdPlacer *)placer;
 ...
 */
-(void)nativeAdWillLeaveApplicationFromCollectionViewAdPlacer:(MSCollectionViewAdPlacer *)placer;

...
/**
 * The `MSInterstitialAdController` class provides a full-screen advertisement that can be
 * displayed during natural transition points in your application.
 */

@interface MSInterstitialAdController : UIViewController
...
/**
 * The delegate (`MSInterstitialAdControllerDelegate`) of the interstitial ad object.
 */
@property (nonatomic, weak) id<MSInterstitialAdControllerDelegate> delegate;
 ...
 * `MSInterstitialAdControllerDelegate` if you would like to be notified as loading succeeds or
 * fails.
 */
- (void)loadAd;
 ...
 * third-party ad networks. See `MSInterstitialAdControllerDelegate` for more details.
 */
 ...
 *
 * `MSInterstitialAdControllerDelegate` provides optional methods that you may implement to stay
 ...
 */
+ (void)removeSharedInterstitialAdController:(MSInterstitialAdController *)controller;
...
/**
 * The delegate of an `MSInterstitialAdController` object must adopt the
 * `MSInterstitialAdControllerDelegate` protocol.
 *
...
@protocol MSInterstitialAdControllerDelegate <NSObject>
 ...
 */
- (void)interstitialDidLoadAd:(MSInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidFailToLoadAd:(MSInterstitialAdController *)interstitial error:(NSError *)error;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialWillAppear:(MSInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidAppear:(MSInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialWillDisappear:(MSInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidDisappear:(MSInterstitialAdController *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidExpire:(MSInterstitialAdController *)interstitial;
...
- (void)interstitialDidPlayStart:(MSInterstitialAdController *)interstitial;
- (void)interstitialDidPlayEnd:(MSInterstitialAdController *)interstitial;

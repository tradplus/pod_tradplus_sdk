...
#import "MeetSocialNativeVideoAdRendererSettings.h"
#import "MeetSocialNativeVideoAdRenderer.h"
...
#define MeetSocialKit [MeetSocial sharedInstance]

@interface MeetSocial : NSObject

/**
 * Returns the MeetSocial singleton object.
 *
 * @return The MeetSocial singleton object.
 */
+ (MeetSocial *)sharedInstance;

/**
 * A Boolean value indicating whether the MeetSocial SDK should use Core Location APIs to automatically

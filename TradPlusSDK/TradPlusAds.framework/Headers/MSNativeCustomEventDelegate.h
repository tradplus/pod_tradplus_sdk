 ...
 * (such as whether an ad has loaded successfully) back to the MeetSocial SDK.
 */
 ...
 *
 * @param event You should pass `self` to allow the MeetSocial SDK to associate this event with the

 ...
 * subclasses of `MSBannerCustomEvent` you can enable the MeetSocial SDK to natively support a wide
 * variety of third-party ad networks.
 *
 * At runtime, the MeetSocial SDK will find and instantiate an `MSBannerCustomEvent` subclass as needed and
...
/**
 * Called when the MeetSocial SDK requires a new banner ad.
 *
